...
async function getCollectionsData(branch, loanOfficer, fromDate, toDate, reportId, reportTrackers, db) {
    return new Promise((resolve, reject) => {
        ...
        // Portfolio loans still subject to collection (monthly Masamba etc. may sit in APPROVED briefly)
                ...
                <table id="collections-table">
                    <thead>
                        ...
                        <tr class="filter-header">
                            <td colspan="12">Loan Collections Report - Filter Information</td>
                        </tr>
                        <tr class="report-info">
                            <td colspan="2">Branch:</td>
                            <td colspan="10">${filterOptions.branch_name || 'All Branches'}</td>
                        </tr>
                        <tr class="report-info">
                            <td colspan="2">Loan Officer:</td>
                            <td colspan="10">${filterOptions.officer_name || 'All Officers'}</td>
                        </tr>
                        <tr class="report-info">
                            <td colspan="2">Date Range:</td>
                            <td colspan="10">${dateFilterText}</td>
                        </tr>
                        <tr class="report-info">
