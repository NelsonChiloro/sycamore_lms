	...
	<div class="card">
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				...
				echo anchor(site_url('savings_products/delete/'.$savings_products->saviings_product_id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure you want to delete it will affect all savings accounts that inherit this feature ?\')"');
				?>
			</td>
		</tr>
					</tbody>
