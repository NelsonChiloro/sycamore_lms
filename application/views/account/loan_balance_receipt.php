...
<button id="printButton" onclick="printMyDiv()" style="padding: 2em; border-radius: 15px;">Print receipt</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<button id="emailD" onclick="openEmail()" style="padding: 2em; border-radius: 15px;">Email receipt</button>
<script>
    let baseURL = "<?php echo base_url()?>";
    let current_id = "<?php echo $this->uri->segment(3); ?>";
    function printMyDiv() {
    ...
    function openEmail() {
        // Replace 'your_email_url' with the actual URL you want to open
        var emailUrl = baseURL+'Account/email_receipt/'+current_id;
