...
if($account->account_status=="Closed"){
	echo anchor(site_url('account/unblock/'.$account->account_id),'Activate','onclick="javasciprt: return confirm(\'Are You Sure you want to blcok this ?\')"');

}else{
	echo anchor(site_url('account/block/'.$account->account_id),'Block','onclick="javasciprt: return confirm(\'Are You Sure you want to blcok this ?\')"');
