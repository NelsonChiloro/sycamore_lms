<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Customer access config rejected</h2>
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                <a href="<?php echo base_url('Admin')?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                <a class="breadcrumb-item" href="#">-</a>
                <span class="breadcrumb-item active">Customer access config rejected</span>
            </nav>
        </div>
    </div>
    <div class="card">
                ...
                foreach ($customer_access_data as $customer_access)
                {
                    ...
                    <tr>
                        ...
                        <td style="text-align:center" width="200px">
                            <a href="<?php echo base_url('Customer_access/auth_action')?>" class="btn btn-approve">Approve</a>
