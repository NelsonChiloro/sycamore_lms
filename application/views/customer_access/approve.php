                ...
                foreach ($customer_access_data as $customer_access)
                {
                    ...
                    <tr>
                        ...
                        <td style="text-align:center" width="200px">
                            <a href="<?php echo base_url('Customer_access/approve_action/').$customer_access->id?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to approve this?')">Approve</a>
                            <a href="<?php echo base_url('Customer_access/reject/').$customer_access->id?>" class="btn btn-warning" onclick="return confirm('Are you sure you want to reject this?')">Reject</a>
