			...
			<table  id="data-table" class="table">
				...
				foreach ($loan_data as $loan)
				{
					...
					<tr>
						...
						<td width="500">
                            <a href="<?php echo base_url('loan/view/').$loan->loan_id?>" class="btn btn-sm btn-info">View</a>
                            <a href="<?php echo base_url('loan/delete_action/').$loan->loan_id?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to do delete this?')">Delete</a>
                            <a href="<?php echo base_url('loan/edit_single_loan_request/').$loan->loan_id?>" class="btn btn-sm btn-success">Edit</a>
                            <a href="#"  onclick="assign_loan_officer('<?php echo $loan->loan_number; ?>','<?php echo $loan->loan_id; ?>')" class="btn btn-sm btn-warning">Change officer</a>
                        </td>
