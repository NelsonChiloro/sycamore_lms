...
<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">Recommend customers</h2>
        <div class="header-sub-title">
            <nav class="breadcrumb breadcrumb-dash">
                <a href="<?php echo base_url('Admin')?>" class="breadcrumb-item"><i class="anticon anticon-home m-r-5"></i>Home</a>
                <a class="breadcrumb-item" href="#">-</a>
                <span class="breadcrumb-item active">All individual customers to recommend</span>
            </nav>
        </div>
    </div>
	<div class="card">
                ...
                foreach ($individual_customers_data as $individual_customers)
                {
                    ...
                    <tr>
                        ...
                        <td style="text-align:center" width="300px">
                            ...
                            <a href="<?php echo base_url('individual_customers/recommend_action/'.$individual_customers->id)?>" class="btn btn-warning" onclick="return confirm('Are you sure you want to recommend this customer?')"><i class="os-icon os-icon-check"></i>Recommend</a>
                            <a href="<?php echo base_url('individual_customers/reject_action/'.$individual_customers->id)?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to reject this customer?')"><i class="fa fa-recycle"></i>Reject</a>
