...
<div class="main-content">
    <div class="page-header">
        <h2 class="header-title">All Revenue collected report</h2>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td style="text-align: left;">  <?php
                      ...
                      $b =  get_collected_interest_product($product->loan_product_id);
                        $round1 = round($b->total);
                        $i +=$round1;
                        echo number_format($round1,2); ?></td>
                    <td style="text-align: left;">  <?php
                        $c =  get_collected_admin_fee_product($product->loan_product_id);
                    ...
                    <td style="text-align: left;">  <?php
                        $d = get_collected_lc_fee_product($product->loan_product_id);

                        $round3 = round($d->total);
                        $lc +=$round3;
                        echo number_format($round3,2); ?></td>
                    <td style="text-align: left;"> <?php
                        $fee = processing_fees($product->loan_product_id);
                        $f += $fee->total_fees;
